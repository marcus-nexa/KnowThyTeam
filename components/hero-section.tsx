                ...
                <section>
                    <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44">
                        <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
                            ...
                            <Image
                                className="-z-10 absolute right-0 top-1/2 -translate-y-1/2 w-full h-[28rem] xl:h-[36rem] 2xl:h-[40rem] max-w-2xl object-contain hidden lg:block"
                                src="/bg-visitor.png"
                                alt="3d Object"
                                width={800}
                                height={600}
                                sizes="(min-width: 1536px) 1000px, (min-width: 1280px) 800px, 600px"
                            />
                        </div>
                    </div>
                </section>
